...
ItemHandlers::UseOnPokemon.add(:BERRY,proc { |item,pkmn,scene|
  next pbHPItem(pkmn,10,scene)
})

ItemHandlers::UseOnPokemon.add(:GOLDBERRY,proc { |item,pkmn,scene|
...
ItemHandlers::UseOnPokemon.copy(:AWAKENING,:MINTBERRY,:BLUEFLUTE,:POKEFLUTE)
...
ItemHandlers::UseOnPokemon.copy(:ANTIDOTE,:PSNCUREBERRY)
...
ItemHandlers::UseOnPokemon.copy(:BURNHEAL,:ICEBERRY)
...
ItemHandlers::UseOnPokemon.copy(:PARLYZHEAL,:PARALYZEHEAL,:PRZCUREBERRY)
...
ItemHandlers::UseOnPokemon.copy(:ICEHEAL,:BURNTBERRY)
