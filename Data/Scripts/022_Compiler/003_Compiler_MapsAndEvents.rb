...
PluginManager.register({
  :name => "Generation 8 Project Scripts",
  :version => "1.5",
  :credits => ["Vendily","TheToxic","HM100","Aioross","Golisopod User","WolfPP","MFilice","lolface","KyureJL","DarrylBD99","Turn20Negate","TheKandinavian","ErwanBeurier."],
  :link => "https://reliccastle.com/resources/493/"
})
=end