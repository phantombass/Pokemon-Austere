class PokeBattle_Battle
    ...
    if wildBattle?
      ...
      when 2
        pbDisplayPaused(_INTL("Wild {1} and {2} appeared!",foeParty[0].name,
           foeParty[1].name))
      when 3
        pbDisplayPaused(_INTL("Wild {1}, {2} and {3} appeared!",foeParty[0].name,
      ...
      when 2
        pbDisplayPaused(_INTL("{1} and {2} want to battle!",@opponent[0].fullname,
           @opponent[1].fullname))
      when 3
        pbDisplayPaused(_INTL("{1}, {2} and {3} want to battle!",
  ...
  def pbGainMoney
    ...
    if trainerBattle?
      ...
      if moneyGained>0
        pbDisplayPaused(_INTL("{1} got ${2} for winning!",$Trainer.name,moneyGained.to_s_formatted))
      end
    end
