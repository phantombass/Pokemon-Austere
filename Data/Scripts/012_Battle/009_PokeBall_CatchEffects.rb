...
BallHandlers::ModifyCatchRate.add(:POKEBALL,proc { |ball,catchRate,battle,battler,ultraBeast|
  next catchRate*255 if $game_system.nuzlocke
})
BallHandlers::ModifyCatchRate.add(:HEALLBALL,proc { |ball,catchRate,battle,battler,ultraBeast|
  next catchRate*255 if $game_system.nuzlocke
})
BallHandlers::ModifyCatchRate.add(:FRIENDBALL,proc { |ball,catchRate,battle,battler,ultraBeast|
  next catchRate*255 if $game_system.nuzlocke
})
