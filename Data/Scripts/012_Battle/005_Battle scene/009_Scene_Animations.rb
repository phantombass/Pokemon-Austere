class PokeBattle_Scene
  ...
  def pbBattleIntroAnimation
    ...
    if @battle.trainerBattle?
	  ...
	  @animations.push(BattleIntroAnimation3.new(@sprites,@viewport,@battle)) # Player
	  @animations.push(BattleIntroAnimation4.new(@sprites,@viewport,@battle)) # Trainer
	  pbWait(1)
	  pbSEPlay("Positioned",100,100)
    ...
    # Set up wild Pokémon and Player back returning to normal colour and playing intro
